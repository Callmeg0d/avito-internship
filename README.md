...
Проект использует **pytest** для интеграционного тестирования.

### Подготовка тестовой БД

Перед запуском тестов нужно создать тестовую БД c TEST_ значениями
...
Тесты используют отдельную тестовую PostgreSQL БД (по умолчанию `avito_test_db`, можно настроить через `TEST_DATABASE_URL`).
...
tests/
  ...
  test_teams.py        # Тесты для команд
  test_pull_requests.py # Тесты для PR и переназначения
```
